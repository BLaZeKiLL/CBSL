...
namespace CBSL.Manager.Tests.Runtime {
    ...
    public class ManagerTest {
        ...
        [OneTimeSetUp]
        public void Setup() {
            EditorSceneManager.LoadSceneInPlayMode("Packages/io.codeblaze.cbsl/Manager/Tests/Runtime/Scene/Test_Manager.unity", new LoadSceneParameters(LoadSceneMode.Single));
        }
